...
def dense_predict(df, utm_column_name):
...
if __name__ == "__main__":
    ...
    revenue_predicted = dense_predict(conversion_paths_test, column_name)
    rmse = measure_results(conversion_paths_test.revenue, revenue_predicted)
    print(f'Dense\tRMSE: {rmse}')

    channels_impact = measure_channels_impact(conversion_paths_test, dense_predict, f'{column_name[:10]}_list')
