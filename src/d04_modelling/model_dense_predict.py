...
def dense_predict(df):
    x_test = df['utm_medium_embedded'].to_list()
...
if __name__ == "__main__":
    ...
    revenue_predicted = dense_predict(conversion_paths_test)
    rmse = measure_results(conversion_paths_test.revenue, revenue_predicted)
    print(f'Dense\tRMSE: {rmse}')

    channels_impact = measure_channels_impact(conversion_paths_test, dense_predict)
